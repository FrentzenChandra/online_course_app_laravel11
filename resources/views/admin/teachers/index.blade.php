                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                    <div class="item-card flex flex-row justify-between items-center">
                        <div class="flex flex-row items-center gap-x-3">
                            <img src="{{Storage::url($teacher->user->avatar)}}" class="rounded-2xl object-cover w-[120px] h-[90px]">
                        ...
                        <div class="sm:hidden md:flex flex-col">
                            <p class="text-slate-500 text-sm">Date</p>
                            <h3 class="text-indigo-950 text-xl font-bold">{{$teacher->user->created_at}}</h3>
                        </div>
                        <div class="sm:hidden md:flex flex-row items-center gap-x-3">
